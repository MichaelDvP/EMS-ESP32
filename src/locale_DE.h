...
MAKE_PSTR_LIST(setFlowTemp, F("setflowtemp"), F("fluss solltemperatur"))
...
MAKE_PSTR_LIST(pumpStatus, F("pumpstatus"), F("pumpen status des hk (PC1)"))
...
MAKE_PSTR_LIST(tempStatus, F("tempstatus"), F("temperatur schalter des hk (MC1)"))
