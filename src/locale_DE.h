...
MAKE_PSTR_LIST(wWStarts, F("wwstarts"), F("# warm wasser starts"))
MAKE_PSTR_LIST(wWStarts2, F("wwstarts2"), F("# warm wasser 2 starts"))
MAKE_PSTR_LIST(wWWorkM, F("wwworkm"), F("aktive zeit"))

// thermostat
// extra commands, not published yet
MAKE_PSTR_LIST(remoteTemp, F("remotetemp"), F("ist temperatur"))
MAKE_PSTR_LIST(switchtime, F("switchtime"), F("schaltzeit"))
MAKE_PSTR_LIST(temp, F("temp"), F("zwischnezeitliche solltemperatur"))
...
MAKE_PSTR_LIST(wwMode, F("wwmode"), F("warm wasser mode"))
MAKE_PSTR_LIST(wwSetTemp, F("wwsettemp"), F("warm wasser soll temperatur"))
MAKE_PSTR_LIST(wwSetTempLow, F("wwsettemplow"), F("warm wasser min soll temperatur"))
MAKE_PSTR_LIST(wwExtra1, F("wwextra1"), F("warm wasser kreis 1 extra"))
MAKE_PSTR_LIST(wwExtra2, F("wwextra2"), F("warm wasser kreis 2 extra"))
...
MAKE_PSTR_LIST(minflowtemp, F("minflowtemp"), F("min fluss temperatur"))
...
MAKE_PSTR_LIST(targetflowtemp, F("targetflowtemp"), F("berechnete fluss temperatur"))
